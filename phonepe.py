...
st.sidebar.markdown(
    ...
    <p>This dashboard app is created by <strong>jefina  vincy</strong></p>
    """,
...
# Sidebar image
st.sidebar.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8xusxYGGb3Ad7D3WhUhz2l68LUi2nM5ntZQ&usqp=CAU", use_column_width=True)
# Define menu options
menu_options = ["🏠🌐 Front Hub", "📉 Top Charts", "🌌 Data Galaxy", " 📝About Details"]
...
if selected_option == "🏠🌐 Front Hub":
    ...
    with col1:
        ...
        st.markdown("### :violet[Tech Stack :] 🐍Python, Pandas, 📜MySQL, 📌Streamlit, 📊Plotly &⬆️more", unsafe_allow_html=True)
...
if selected_option == "📉 Top Charts":
    ...
    if Type == "🗂️ User Data":
        ...
        # MENU 3 - EXPLORE DATA
if selected_option == "🌌 Data Galaxy":
  ...
  if Type == "Users":
    ...
    fig = px.bar(df,
               ...
               color_continuous_scale=px.colors.sequential.Agsunset)
    st.plotly_chart(fig,use_container_width=True)
if selected_option == " 📝About Details":
    ...
    with col2:
        st.image("https://cdn.inc42.com/wp-content/uploads/2021/11/PhonePe-Feature.jpg")
        st.image("https://images.moneycontrol.com/static-mcnews/2020/12/PhonePe-App.jpg?impolicy=website&width=770&height=431")
        st.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0XvJpGggceifKwK0uUz8VBn0zda1xt7hU5Q&usqp=CAU")